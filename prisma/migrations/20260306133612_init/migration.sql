...
CREATE TABLE "UserTrainData" (
    ...
    CONSTRAINT "UserTrainData_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "WorkoutPlan" (
    ...
    "estimateDurationInSeconds" INTEGER NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "UserTrainData_userId_key" ON "UserTrainData"("userId");
